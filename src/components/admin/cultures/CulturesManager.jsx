...
const CulturesManager = ({ token, API_BASE, SERVER_ORIGIN, showMessage, onUnauthorized }) => {
  const { cultures, loading, refetch: fetchData } = useCultures({ onUnauthorized });
  ...
  return (
    <div>
      ...
      <AdminTable
        ...
        data={cultures}
        columns={columns}
        emptyMessage="Belum ada data kebudayaan di database backend."
        editId={editId}
      />
